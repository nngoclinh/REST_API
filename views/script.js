document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("submit", function (event) {
      ...
      const dob = document.getElementById("dob").value; // Date value in yyyy-mm-dd format from date picker
      ...
      fetch(apiUrl, {
        ...
        body: JSON.stringify({ name, age, dob, email }), // Use dob directly in yyyy-mm-dd format
      })
        .then((response) => {
          if (!response.ok) {
  ...
  const addStudent = () => {
    ...
    addButton.onclick = null; // Remove any existing click event listeners
  };
